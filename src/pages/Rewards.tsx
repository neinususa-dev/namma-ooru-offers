              ...
              <div className="w-full overflow-x-auto pb-2">
                <TabsList className="grid grid-cols-4 gap-1 md:gap-2 min-w-max md:min-w-0 bg-gradient-to-r from-blue-50 to-purple-50 p-2 rounded-2xl w-full">
                  ...
                  >
                    ...
                    <span className="text-[10px] md:text-sm font-medium leading-tight">Dashboard</span>
                  </TabsTrigger>
                  <TabsTrigger 
                    value="earn" 
                    className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-green-500 data-[state=active]:to-green-600 data-[state=active]:text-white data-[state=active]:shadow-lg bg-green-100 hover:bg-green-200 data-[state=active]:hover:bg-green-600 transition-all duration-300 rounded-xl font-semibold text-xs md:text-sm py-2 md:py-3 px-1 md:px-4 flex flex-col items-center justify-center gap-1 min-w-[70px] md:min-w-0 text-green-700 data-[state=active]:text-white"
                  >
                    <Coins className="h-3 w-3 md:h-4 md:w-4 flex-shrink-0" />
                    <span className="text-[10px] md:text-sm font-medium leading-tight">Earn</span>
                  </TabsTrigger>
                  <TabsTrigger 
                    value="redeem" 
                    className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-orange-600 data-[state=active]:text-white data-[state=active]:shadow-lg bg-orange-100 hover:bg-orange-200 data-[state=active]:hover:bg-orange-600 transition-all duration-300 rounded-xl font-semibold text-xs md:text-sm py-2 md:py-3 px-1 md:px-4 flex flex-col items-center justify-center gap-1 min-w-[70px] md:min-w-0 text-orange-700 data-[state=active]:text-white"
                  >
                    <Gift className="h-3 w-3 md:h-4 md:w-4 flex-shrink-0" />
                    <span className="text-[10px] md:text-sm font-medium leading-tight">Redeem</span>
                  </TabsTrigger>
                  <TabsTrigger 
                    value="activity" 
                    className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-purple-600 data-[state=active]:text-white data-[state=active]:shadow-lg bg-purple-100 hover:bg-purple-200 data-[state=active]:hover:bg-purple-600 transition-all duration-300 rounded-xl font-semibold text-xs md:text-sm py-2 md:py-3 px-1 md:px-4 flex flex-col items-center justify-center gap-1 min-w-[70px] md:min-w-0 text-purple-700 data-[state=active]:text-white"
                  >
