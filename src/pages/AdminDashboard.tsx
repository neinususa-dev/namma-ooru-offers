      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-6 mb-6">
          ...
          >
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">{allOffers.offers?.length || 0}</div>
              <p className="text-xs text-muted-foreground mt-1">Click to view offers</p>
            </CardContent>
          </Card>
          ...
          >
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">Click to review offers</p>
            </CardContent>
          </Card>
          ...
          >
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">Click to view approved</p>
            </CardContent>
          </Card>
        </div>
